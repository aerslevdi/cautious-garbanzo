...
public class DefaultSettings {
    ...
    // remember list preference will return entryValues, that means,
    // values are strings
    public static String getListPrefereceThemesValue(Context context) {
        getSharedPreferencesInstance(context);
        return sharedPreferences.getString("listPreferenceThemes", "2");
    }
