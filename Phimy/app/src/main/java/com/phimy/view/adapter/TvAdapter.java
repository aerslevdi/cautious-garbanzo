...
public class TvAdapter extends RecyclerView.Adapter<TvAdapter.MovieViewHolder> implements ItemTouchHelperAdapter, Filterable {
    ...
    public TvAdapter(Context context, Receptor receptor, List<MovieDB> movieList, Integer resources, Drawable imageFavorito, Drawable imageNoFavorito) {
        ...
        public MovieViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    receptor.recibir(movieDB, getAdapterPosition(), "TvFragment");
                }
            });
        }
