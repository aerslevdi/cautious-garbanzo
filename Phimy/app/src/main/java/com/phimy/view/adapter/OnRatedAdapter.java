...
public class OnRatedAdapter extends RecyclerView.Adapter<OnRatedAdapter.MovieViewHolder> implements ItemTouchHelperAdapter, Filterable {
    ...
    public OnRatedAdapter(Context context, Receptor receptor, List<MovieDB> movieList, Integer resources, Drawable imageFavorito, Drawable imageNoFavorito) {
        ...
        public MovieViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    receptor.recibir(movieDB, getAdapterPosition(), movieList, "OnRatedFragment");
                }
            });
        }
